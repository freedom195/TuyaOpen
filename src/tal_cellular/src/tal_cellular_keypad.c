...
{
    if(cellular_keypad_desc_get()->init == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_keypad_desc_get()->init(param);
}
...
{
    if(cellular_keypad_desc_get()->key_listener_add == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_keypad_desc_get()->key_listener_add(keyId, cb, ctx);
}
...
{
    if(cellular_keypad_desc_get()->key_listener_delete == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_keypad_desc_get()->key_listener_delete(listener);
}
...
{
    if(cellular_keypad_desc_get()->key_state_get == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_keypad_desc_get()->key_state_get(keyId, state);
}
...
{
    if(cellular_keypad_desc_get()->key_ioctl == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_keypad_desc_get()->key_ioctl(cmd, argv);
}