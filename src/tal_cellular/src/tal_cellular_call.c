...
{
    if (cellular_call_desc_get()->call_service_available == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->call_service_available(sim_id, enable);
}
...
{
    if(cellular_call_desc_get()->call == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->call(sim_id, callNum);
}
...
{
    if(cellular_call_desc_get()->answer == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->answer(sim_id);
}
...
{
    if(cellular_call_desc_get()->hungup == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->hungup(sim_id);
}
...
{
    if(cellular_call_desc_get()->cb_register == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->cb_register(callback);
}
...
{
    if(cellular_call_desc_get()->set_callin_mute == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->set_callin_mute(mute);
}
...
{
    if(cellular_call_desc_get()->set_volte == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->set_volte(simId, enable);
}
...
{
    if(cellular_call_desc_get()->set_voice_mute == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->set_voice_mute(mute);
}
...
{
    if(cellular_call_desc_get()->get_voice_mute == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->get_voice_mute(mute);
}
...
{
    if(cellular_call_desc_get()->set_voice_vol == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->set_voice_vol(vol);
}
...
{
    if(cellular_call_desc_get()->get_voice_vol == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->get_voice_vol(vol);
}
...
{
    if(cellular_call_desc_get()->play_tone == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->play_tone(tone, duration);
}
...
{
    if(cellular_call_desc_get()->stop_tone == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->stop_tone();
}
...
{
    if(cellular_call_desc_get()->dtmf2voice == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->dtmf2voice(dtmfTone, duration);
}
...
{
    if(cellular_call_desc_get()->reg_KTDetect == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->reg_KTDetect(cb);
}
...
{
    if (NULL == cellular_call_desc_get()) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->ctrl_KTDetect(enable);
}
...
{
    if(cellular_call_desc_get()->ioctl == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return cellular_call_desc_get()->ioctl(cmd, argv);
}
